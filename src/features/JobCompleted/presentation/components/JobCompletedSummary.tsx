    ...
    <div className="bg-white rounded-[20px] p-6 border border-gray-200 shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2 px-4 py-1.5 bg-emerald-50 text-emerald-600 rounded-full border border-emerald-200">
          ...
          <span className="text-sm font-semibold">{t.jobcompletedpage.completed}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {[
          [t.jobcompletedpage.serviceType, "Plumbing Repair"],
          [t.jobcompletedpage.serviceTier, "Standard"],
          [t.jobcompletedpage.date, "January 31, 2026"],
          [t.jobcompletedpage.duration, "1h 15min"],
        ].map(([label, value]) => (
