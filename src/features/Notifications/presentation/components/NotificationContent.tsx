    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center py-20 sm:py-28 px-6">
        <div className="relative mb-6">
          <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gray-100/80 flex items-center justify-center">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gray-50 border border-gray-200 flex items-center justify-center">
              <Bell className="w-6 h-6 sm:w-7 sm:h-7 text-gray-300" />
            </div>
          </div>
        </div>

        <h3 className="text-sm sm:text-[15px] font-semibold text-gray-700 mb-1.5">
          {t.notificationpage.noNotifications}
        </h3>

        <p className="text-xs sm:text-[13px] text-gray-400 max-w-[220px] leading-relaxed">
  ...
  <div className="flex gap-2 sm:gap-4">
    ...
    <div className="flex-1 min-w-0">
      <div className="flex flex-col">
        ...
        {/* Footer */}
        <div className="flex flex-col xs:flex-row sm:flex-row justify-between items-start sm:items-center gap-2 mt-3">
          <span
            className="
