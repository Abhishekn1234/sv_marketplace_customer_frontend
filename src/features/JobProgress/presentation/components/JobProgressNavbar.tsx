...
export default function JobProgressNavbar() {
  return (
    <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 relative">
      ...
      {/* Location - Hidden on sm and below */}
      <div className="hidden sm:flex items-center gap-2 text-gray-500 text-sm sm:text-[15px] font-medium px-4 py-2 bg-white rounded-full border border-gray-200 transition-all duration-200 cursor-pointer hover:border-blue-600 hover:text-blue-600 hover:shadow-sm group w-fit">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
