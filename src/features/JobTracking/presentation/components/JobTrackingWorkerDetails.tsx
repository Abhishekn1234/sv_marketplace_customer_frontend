  ...
  if (!worker) {
    return (
      <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
        <h2 className="text-base font-bold text-gray-900">Your Professional</h2>
        <p className="text-sm text-gray-500 mt-3">Worker not assigned yet</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
      ...
      <div className="flex items-center gap-4 mb-5">
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-gray-500">
            {booking?.service?.name ?? "Service"} • {booking?.serviceTier?.displayName ?? "Tier"}
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        <a
          ...
          className="flex-1 h-12 rounded-lg bg-blue-600 text-white font-semibold shadow-md hover:bg-blue-700 flex items-center justify-center gap-2"
        >
          Call
        </a>

        <button className="flex-1 h-12 rounded-lg bg-white border border-gray-200 font-semibold text-gray-900 hover:bg-gray-50 flex items-center justify-center gap-2">
          Message
        </button>
      </div>
    </div>
