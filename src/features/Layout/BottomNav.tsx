    ...
    return (
        <nav
            ...
            className="
                ...
                /* Responsive width: 90% on mobile, auto on larger screens */
                w-[90%] sm:w-auto 
...
// Added responsive sizing to the icon base
const iconBase = "w-5 h-5 sm:w-6 sm:h-6 transition-colors duration-200";

const HomeIcon = () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`${iconBase} text-blue-600`}>
...
const SearchIcon = () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`${iconBase} text-gray-400 group-hover:text-gray-600`}>
