...
export default function BookingSummary({
  ...
  return (
    <div
      className={`bg-white border-2 border-gray-200 rounded-2xl overflow-hidden mb-8 shadow-lg ${
    ...
    >
      ...
      <div className="px-6 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
          ...
          <SummaryItem
            label={t.confirmationpage.bookingSummary.totalPaid}
            value={
        ...
        {/* Info Box */}
        <div
          className={`flex items-start gap-4 p-5 bg-emerald-50 border-2 border-emerald-200 rounded-xl ${
