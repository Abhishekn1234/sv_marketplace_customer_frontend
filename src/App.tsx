...
import {
  LanguageProvider,
} from "./features/context/LanguageContext";
...
import {
  useAuthStore,
} from "./features/core/store/auth";

import {
  initializeSocket,
} from "./features/core/Websocket/socket";
    ...
    const setupNotifications = async () => {
      try {
        ...
        if (!existingReg) {
          ...
          // console.log(
          //   "♻️ Service Worker already active"
          // );
        }
        ...
        // console.log(
        //   "✅ Foreground listener initialized"
        // );
      } catch (err) {
        console.error(
